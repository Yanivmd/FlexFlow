# -*- coding: utf-8 -*-
"""Bidirectional encoder representation from Transformers.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/13FjI_uXaw8JJGjzjVX3qKSLyW9p3b6OV
...
from examples.python.pytorch.customed_tracer import ArangeForFx
...
class Embedding(nn.Module):
    ...
    def forward(self, x, seg):
        seq_len = x.size(1)
        pos = self.arange(seq_len, dtype=torch.long)
...
class MultiHeadAttention(nn.Module):
    def __init__(self):
        ...
        self.Linear_head_v_model = nn.Linear(n_heads * d_v, d_model)
        self.LayerNorm_d_model = nn.LayerNorm(d_model)
    ...
    def forward(self, Q, K, V, attn_mask):
        ...
        output = self.Linear_head_v_model(context)
        return self.LayerNorm_d_model(output + residual), attn  # output: [batch_size x len_q x d_model]
